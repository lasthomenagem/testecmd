	...
	<div class="navbar navbar-fixed-top" style="background-color: #ec6707;">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				<li><a class="mt-3 zoom1" href="index.php" style="color: white; font-size: 1.7rem"><span class="glyphicon glyphicon-home"></span>&nbsp Início</a></li>
				<li><a class="mt-3 zoom1" href="index.php" style="color: white; font-size: 1.7rem; background-color:transparent"><span class="glyphicon glyphicon-earphone"></span>&nbsp  Televendas | (11) 97485-3258 </a></li>
				<li style="width:300px;left:10px;top:10px;">
				<li><a class="mt-3 zoom1" href="quemsomos.php" style="color: white; font-size: 1.7rem; ; background-color:transparent"><i class="fas fa-users text-white;  background-color:transparent"></i>&nbsp Quem somos</a></li>
			...
			<li><a href="#" class="dropdown-toggle mt-3 hos" data-toggle="dropdown" style="color: white; font-size: 1.7rem">
				...
				<span class="mt-3 glyphicon glyphicon-shopping-cart" style="color: white;"></span>&nbspCarrinho&nbsp<span class="badge">0</span></a>

					<div class="dropdown-menu"  id="carrinhopop">
						<div class="panel panel-success">
							<div class="panel-heading hos">
								<div class="row">
									<div class="col-md-3 col-xs-3">Ordem</div>
									<div class="col-md-3 col-xs-3">Imagem</div>
									<div class="col-md-3 col-xs-3">Nome do produto</div>
									<div class="col-md-3 col-xs-3">Prreço <?php echo CURRENCY; ?></div>
								</div>
							</div>
				...
				<li><a href="#" class="dropdown-toggle mt-3" data-toggle="dropdown" style="color: white;"><span class="glyphicon glyphicon-user" style="color: white; font-size: 1.7rem"></span><?php echo "&nbspOlá,".$_SESSION["name"]; ?></a>
					<ul class="dropdown-menu">

					
						<li><a href="cart.php" style="text-decoration:none; color:darkmagenta;"><span class="glyphicon glyphicon-shopping-cart">Carrinho</a></li>
						<li class="divider"></li>
						<li><a href="customer_order.php" style="text-decoration:none; color:darkmagenta;">Pedidos</a></li>
						<li class="divider"></li>
						<li><a href="" style="text-decoration:none; color:darkmagenta;">Trocar Senha</a></li>
						<li class="divider"></li>
						<li><a href="logout.php" style="text-decoration:none; color:darkmagenta;">Sair</a></li>
					</ul>
				</li>
