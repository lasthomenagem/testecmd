        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="cat_title" class="form-control" placeholder="Insira o nome da categoria">
		        	</div>
        		</div>
        ...
        <form id="edit-category-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                <label>Nome da categoria</label>
                <input type="text" name="e_cat_title" class="form-control" placeholder="Insira o nome da Marca">
              </div>
            </div>
