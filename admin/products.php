        ...
        <form id="add-product-form" enctype="multipart/form-data">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <input type="number" name="product_qty" class="form-control" placeholder="Insira a quantidade em estoque">
              </div>
            </div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Preço do produto</label>
		        		<input type="number" name="product_price" class="form-control" placeholder="Insira o valor do produto">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>palavras chave <small>(ex: apple, iphone, móvel)</small></label>
		        		<input type="text" name="product_keywords" class="form-control" placeholder="Insira as palavras chaves">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
        ...
        <form id="edit-product-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                <label>Nome do produto</label>
                <input type="text" name="e_product_name" class="form-control" placeholder="Insira o nome do produto">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
            ...
            <div class="col-12">
              <div class="form-group">
                <label>Quantidade do produto</label>
                <input type="number" name="e_product_qty" class="form-control" placeholder="Insira a quantidade">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Preço do produto</label>
                <input type="number" name="e_product_price" class="form-control" placeholder="Insira o valor do produto">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Palavras-chave <small>(eg: apple, iphone, mobile)</small></label>
                <input type="text" name="e_product_keywords" class="form-control" placeholder="Palavras-chave">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
