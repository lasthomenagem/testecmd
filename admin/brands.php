        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="brand_title" class="form-control" placeholder="Insira o nome da marca">
		        	</div>
        		</div>
        ...
        <form id="edit-brand-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                <label>Nome da marca</label>
                <input type="text" name="e_brand_title" class="form-control" placeholder="Insira o nome da marca">
              </div>
            </div>
